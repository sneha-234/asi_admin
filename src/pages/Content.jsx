...
{content.hero_image && (
  <img
    src={`https://cms.asiindore.co.in${content.hero_image}`}
    alt="Hero"
    width="200"
  />
)}
            ...
            <div className="content-card">
              ...
              <label>Leader Image 1</label>
                ...
                {content.leader_image_1 && (
                  <img
                    src={`https://cms.asiindore.co.in${content.leader_image_1}`}
                    alt="Leader 1"
                    width="200"
                  />
                )}
              ...
              <label>Leader Image 2</label>
                ...
                {content.leader_image_2 && (
                  <img
                    src={`https://cms.asiindore.co.in${content.leader_image_2}`}
                    alt="Leader 2"
                    width="200"
                  />
                )}
