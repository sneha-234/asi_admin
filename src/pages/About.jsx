...
{aboutData.hero_image && (
  ...
  <img
    src={`https://cms.asiindore.co.in${aboutData.hero_image}`}
    width="150"
    alt=""
  />
...
{aboutData.vision_image && (
  ...
  <img
    src={`https://cms.asiindore.co.in${aboutData.vision_image}`}
    width="150"
    alt=""
  />
...
{aboutData.presence_image1 && (
  ...
  <img
    src={`https://cms.asiindore.co.in${aboutData.presence_image1}`}
    width="150"
    alt=""
  />
...
{aboutData.presence_image2 && (
  ...
  <img
    src={`https://cms.asiindore.co.in${aboutData.presence_image2}`}
    width="150"
    alt=""
  />
